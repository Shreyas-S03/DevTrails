              ...
              <div className="group relative overflow-hidden bg-slate-900/40 backdrop-blur-2xl border border-slate-700/50 hover:border-indigo-500/50 rounded-3xl p-6 transition-all duration-300 hover:-translate-y-1 block hover:bg-slate-800/60 hover:shadow-[0_0_40px_rgba(99,102,241,0.15)] flex flex-col justify-between">
                ...
                <div className="mt-8 relative z-10">
                  ...
                  <button
                    ...
                    disabled={quoting}
                    className="mt-4 flex w-fit items-center gap-2 text-xs font-bold text-indigo-400 bg-indigo-500/10 hover:bg-indigo-500/20 px-3.5 py-2 rounded-full transition-colors border border-indigo-500/20"
                  >
                    {quoting ? <span className="w-3.5 h-3.5 border-2 border-indigo-400 border-t-transparent rounded-full animate-spin" /> : <Activity className="w-3.5 h-3.5" />}
